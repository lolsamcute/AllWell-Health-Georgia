                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="footer-copyright-area text-center">
                                    <p class="white-color">Copyright ©{{date('Y')}} <strong><a class="white-color" href="#">AllWell Health Georgia. </a></strong> All rights reserved. Designed by <strong><a style="color:red;" href="https://www.animoplasty.com" target="_blank">Animoplasty</a></strong> </p> 
                                </div>
                            </div>
                        </div>
                    </div>
